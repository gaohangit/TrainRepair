...
public class PacketInfo {
    ...
    public String getPacketCodeName() {
        return packetCodeName;
    }

    public void setPacketCodeName(String packetCodeName) {
        this.packetCodeName = packetCodeName;
    }
