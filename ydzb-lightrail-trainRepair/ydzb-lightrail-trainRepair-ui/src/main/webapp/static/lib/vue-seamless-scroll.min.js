        ...
        computed: {
          ...
          leftSwitch: function () {
            return {
              position: 'absolute',
              margin:
                this.height / 2 + 'px 0 0 -' + this.options.switchOffset + 'px',
          ...
          if (null != (i = arguments[h]))
            for (t in i)
              (n = l[t]),
                ...
                c &&
                s &&
                ('object' === (void 0 === s ? 'undefined' : o(s)) || r)
                  ? (r
                      ? ((r = !1), (a = n && Array.isArray(n) ? n : []))
                      : (a =
                          n && 'object' === (void 0 === n ? 'undefined' : o(n))
                            ? n
                            : {}),
                    (l[t] = e(c, a, s)))
                  : void 0 !== s && (l[t] = s);
